...
|---|---|---|---|
| workspace-light.png | Reviewed light workspace baseline | 174 KB | Docs + baseline mirror |
| workspace-dark.png | Reviewed dark workspace baseline | 136 KB | Docs + baseline mirror |
| workspace-tablet.png | 1024px workspace breakpoint capture | 127 KB | VISUAL-REVIEW |
...
| graph.png | Reviewed graph baseline | 72 KB | Docs + baseline mirror |
| canvas.png | Spatial canvas board for visual note arrangement | 72 KB | VISUAL-REVIEW, STORE-MIGRATION, CAPABILITIES |
...
| settings.png | Runtime config, vault config, appearance, diagnostics | 158 KB | VISUAL-REVIEW, STORE-MIGRATION |
...
| inspector-preview.png | Inspector preview mode with editor/preview controls | 175 KB | VISUAL-REVIEW |
