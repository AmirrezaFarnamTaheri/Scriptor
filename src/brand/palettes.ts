...
export const COLOR_PALETTE_SCHEMES: ColorPaletteScheme[] = [
  ...
  },
  {
    ...
    name: 'Rosé Pine',
    category: 'dark',
    description: 'All-natural palette with soft rose pink, muted gold, and pine accents.',
    author: 'Rosé Pine',
    colors: {
      bg: '#191724',
      surface: '#1f1d2e',
  ...
  },
  {
    ...
    name: 'Synthwave 84',
    category: 'dark',
    description: 'Neon 80s retro-futurist aesthetic with glowing magenta and cyan.',
    author: 'Robb Owen',
    colors: {
      bg: '#241b2f',
      surface: '#2e233c',
  ...
  },
  {
    ...
    name: 'One Dark Pro',
    category: 'dark',
    description: 'Classic Atom slate blue aesthetic with soft blue and gold accents.',
    author: 'Binaryify',
    colors: {
      bg: '#21252b',
      surface: '#282c34',
  ...
  },
  {
    ...
    name: 'Vitesse Dark',
    category: 'dark',
    description: 'Clean, understated dark theme with warm terracotta amber and emerald.',
    author: 'Anthony Fu',
    colors: {
      bg: '#121212',
      surface: '#181818',
  ...
  },
  {
    ...
    category: 'contrast',
    description: 'Ultra deep pure black background with vibrant mint green accents.',
    author: 'Scriptor Team',
    colors: {
      bg: '#000000',
      surface: '#050505',
