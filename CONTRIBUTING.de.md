...
Entwurfs-PRs bleiben absichtlich leichtgewichtig: aufwendige CI-, Desktop-Compile-, Visual-Review- und Starlight-Lock-Jobs warten, bis der PR reviewbereit ist. **Ready for review** startet einen vollständigen Lauf für den exakten Head; spätere Pushes brechen veraltete PR-Läufe ab und prüfen nur den neuesten Head. **Release Binary Review** ist ausschließlich manuell und wird separat für einen eingefrorenen Release-Kandidaten gestartet.
