...
| RUSTSEC-2025-0057 | `fxhash` via `scraper` capture stack | CLI capture/extraction; upstream reports no safe compatible upgrade | Release/Security | https://rustsec.org/advisories/RUSTSEC-2025-0057.html | 2026-10-01 | Replace `scraper`/selector dependency or migrate to a maintained hash implementation |
