...
### Fixed
- Rolled the RustSec exception ledger to its September review (19 owned exceptions re-attested, next review 2026-10-01): the missed 2026-09-01 date had turned the governance contracts and the container smoke red across CI; `cargo deny check` itself is green on the current graph.
