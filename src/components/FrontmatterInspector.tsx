...
export function FrontmatterInspector({ path, fields, onClose, onSaved }: FrontmatterInspectorProps) {
  ...
  return (
    <div className="modal-backdrop" role="presentation" onClick={onClose}>
      <section ref={dialogRef} className="frontmatter-inspector" data-help-topic="frontmatter" role="dialog" aria-modal="true" aria-label="Frontmatter" onClick={(e) => e.stopPropagation()}>
        <header>
          <h2>Frontmatter</h2>
