...
| RUSTSEC-2024-0384 | Transitive product dependency | Product dependency graph; no safe compatible upgrade recorded | Release/Security | https://rustsec.org/advisories/RUSTSEC-2024-0384.html | 2026-09-01 | Remove on patched parent release or replace the parent dependency |
...
| RUSTSEC-2026-0192 | Font/text rendering dependency | Canvas and document rendering paths | Release/Security | https://rustsec.org/advisories/RUSTSEC-2026-0192.html | 2026-09-01 | Remove when the rendering parent adopts a maintained font parser |
| RUSTSEC-2026-0206 | Transitive product dependency | Product dependency graph; no safe compatible upgrade recorded | Release/Security | https://rustsec.org/advisories/RUSTSEC-2026-0206.html | 2026-09-01 | Remove on patched parent release or replace the parent dependency |
