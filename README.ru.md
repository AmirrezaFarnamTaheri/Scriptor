...
Продакшен-установщики публикуются как артефакты GitHub Release. Текущая версия — **1.0.11**.
