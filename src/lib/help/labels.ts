const en = {
  ...
  hints: 'Show first-use guide invitations', reset: 'Reset guide progress', resetAsk: 'Reset all guide progress and first-use invitations? Notes, accounts, and application settings will not change.',
...
const de: HelpLabels = {
  ...
  hints: 'Anleitungshinweise beim ersten Einsatz anzeigen', reset: 'Anleitungsfortschritt zurücksetzen', resetAsk: 'Fortschritt und Erstbenutzungshinweise zurücksetzen? Notizen, Konten und Anwendungseinstellungen bleiben unverändert.',
...
const fa: HelpLabels = {
  ...
  hints: 'نمایش پیشنهاد راهنما در نخستین استفاده', reset: 'بازنشانی پیشرفت راهنماها', resetAsk: 'پیشرفت و پیشنهادهای نخستین استفاده بازنشانی شوند؟ یادداشت‌ها، حساب‌ها و تنظیمات برنامه تغییر نمی‌کنند.',
