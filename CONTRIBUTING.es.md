...
Los PR en borrador son deliberadamente ligeros: los jobs pesados de CI, compilación de escritorio, Visual review y Starlight lock se aplazan hasta que el PR esté listo para revisión. **Ready for review** dispara una validación completa del head exacto; los pushes posteriores cancelan ejecuciones obsoletas y validan solo el head más reciente. **Release Binary Review** es solo manual y se ejecuta por separado para un candidato de release congelado.
